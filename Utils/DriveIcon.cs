...
namespace GModMountManager.Utils
{
    public class c_icon_of_path
    {
        ...
        private static extern int SHGetSpecialFolderLocation(IntPtr hwndOwner, Int32 nFolder,
                 ref IntPtr ppidl);
        ...
        public static BitmapSource SystemIcon(bool small)
        {
            IntPtr pidlTrash = IntPtr.Zero;
            int hr = SHGetSpecialFolderLocation(IntPtr.Zero, 1, ref pidlTrash);
            Debug.Assert(hr == 0);
