...
namespace GModMountManager
{
    public static partial class Utils
    {
        ...
        internal static Image CreateThumbnail(string title, int order, Font font, Color? _textColor = null, Color? _backColor = null, int height = 0, int width = 0)
        {
            ...
            if (height < 1)
            {
                SizeF textSize = drawing.MeasureString(title, font);
                img.Dispose();
                drawing.Dispose();
            ...
            drawing.DrawString(title, font, textBrush, 0, 0);
